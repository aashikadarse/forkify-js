...
const loadRecipe = async function(id) {
    try {
        ...
        //some() returns true if any one element matches 
...
const KEY = '5cadbeef-ac56-4b91-9192-bbec25e4230a';
...
//url: parcel converts svg into a reusable URL
// import icons from '../img/icons.svg';
// import { Fraction }  from 'fractional';//error
var _fracty = require("fracty"); // for converting decimals to fractions
...
},{"url:../../img/icons.svg":"fd0vu","./View.js":"jSw21","./previewView.js":"6tKHS","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6tKHS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    addHandlerClick(handler) {
        this._parentElement.addEventListener('click', function(e) {
            ...
            // console.log(btn);
            if (!btn) return;
            const goToPage = +btn.dataset.goto; //Unary plus converts:string to number
    ...
    _generateMarkup() {
        ...
        if (this._data.page === 1 && numPages > 1) return `<button data-goto="${curPage + 1}" class="btn--inline pagination__btn--next">
...
},{"url:../../img/icons.svg":"fd0vu","./View.js":"jSw21","./previewView.js":"6tKHS","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8AWnP":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
class addRecipeView extends (0, _viewJsDefault.default) {
    ...
    addHandlerUpload(handler) {
        this._parentElement.addEventListener('submit', function(e) {
            ...
            const data = Object.fromEntries(dataArr); //Object.fromEntries(iterable)converts an array of[key, value]pairs back into an object
            handler(data);
        });
    }
    _generateMarkup() {}
...
//# sourceMappingURL=forkify - Copy.4a59a05f.js.map
